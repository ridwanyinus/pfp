...
const Hero = () => {
  return (
    <section className="pb-20 pt-10 h-full">
      ...
      <section className="relative flex flex-col medium:flex-row  justify-center medium:items-center mt-10 px-5 xl:pl-14 desktop:px-24 largesceen:px-48 largesceen:gap-10">
        ...
        <div className="mt-20 medium:mt-0 flex-1 justify-center  medium:justify-end xl:justify-center  items-center flex">
          <Image alt="developer" src={dev} className="medium:w-[280px] lg:w-[369px] desktop:w-[500px] largesceen:w-[600px]" />
        </div>
      </section>
    </section>
  );
